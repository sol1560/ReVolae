...
import { AppInventory, CapabilityCard, PrivacySettings } from "../src/common.js";
const dir = join(import.meta.dir, "..", "schema");
mkdirSync(dir, { recursive: true });
for (const [name, s] of Object.entries({ AnyMessage, PairOffer, CapabilityCard, PrivacySettings, AppInventory })) {
